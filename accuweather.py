    ...
    def get_location_key(self, latitude, longitude):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                if not data:
                    raise RuntimeError(f"No location found by cords: {longitude=}, {latitude=}")
...
if __name__ == '__main__':
    ...
    pprint(data)
'''
{"Code":"ServiceUnavailable","Message":"The allowed number of requests has been exceeded.","Reference":"/forecasts/v1/daily/5day/208683?apikey=YAXJ2BgVH2LFs9nH0O9WZFYUjfkV4nXm&details=True&metric=True"}
'''